...
const Register = () => {
  ...
  const validYup = yup.object().shape(
    {
      name: yup.string().required("Name is required").min(2, "Name must be at least 2 characters").max(20, "Name must be 20 characters at most"),
      ...
      phone: yup.string().required("Phone is required").matches(/^01[0125][0-9]{8}$/, "Enter a valid egyptian number")
    }
  )
  ...
  return (
    <section className=' py-12'>
      <div className="container mx-auto">
        <h1 className=' text-5xl text-green-500 text-center font-bold mb-12'>Register</h1>
        <div className=' w-[90%] md:w-[70%] lg:w-[50%] xl:w-[40%] mx-auto'>
          <form onSubmit={formik.handleSubmit} autoComplete='on'>
            ...
            <div className="relative z-0 w-full mb-5 group">
              ...
              <label htmlFor="rePassword" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Re-Password</label>
            </div>
